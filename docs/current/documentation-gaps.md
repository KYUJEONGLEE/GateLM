...
|---|---|---|
| DOC-014 | 2026-07-17: unsupported `userId` quota override wording was removed. Tenant Chat instead documents a signed-employee weekly token quota in the RuntimeSnapshot, policy/audit rows, and weekly ledger. | [`../tenant-chat/contracts.md`](../tenant-chat/contracts.md), `tenant_chat_employee_weekly_token_*` migration |
...
| DOC-025 | 2026-07-19 owner directive로 non-authoritative request shadow의 106D/E5 경로를 42D B1으로 reset했다. B1은 L2/liblinear Logistic Regression `C=10`, Isotonic과 threshold `0.5`를 사용하며 content hash `sha256:6fdd46325175cb36189f33c2e590841165be13f081c44b982400da13f17d38a9`로 동결한다. Projection `P=6`과 semantic-head `C=10`은 후속 semantic 실험의 baseline provenance에만 포함되고 42D B1 추론에는 사용하지 않는다. 기존 106D bundle은 request shadow에서 제거했지만 별도 opt-in authoritative E5 hot runtime 계약은 변경하지 않았다. | [`../routing/contracts.md`](../routing/contracts.md), [`../testing/difficulty-semantic-b1-baseline-report.md`](../testing/difficulty-semantic-b1-baseline-report.md), [`../../scripts/routing_difficulty_model/artifacts/difficulty-logistic.semantic-b1.model-path-5000.v1.json`](../../scripts/routing_difficulty_model/artifacts/difficulty-logistic.semantic-b1.model-path-5000.v1.json) |
