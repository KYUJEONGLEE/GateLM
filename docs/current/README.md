...
| Routing 난이도 데이터셋 구축 | [`../routing/datasets/difficulty/README.md`](../routing/datasets/difficulty/README.md) | Version-independent data work area; owner-approved 15,000-record training revision available |
...
- `routing/datasets/difficulty`: 제품 SemVer와 분리된 난이도 데이터 작업 영역. 후보 revision은 증거로 보존하며, 전수 사람 검수와 dataset-owner 승인을 받은 15,000개 별도 revision은 학습 사용 가능 상태
