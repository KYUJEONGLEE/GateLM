...
| Routing 난이도 데이터셋 구축 | [`../routing/datasets/difficulty/README.md`](../routing/datasets/difficulty/README.md) | Version-independent data work area; generated candidates are not training eligible |
...
- `routing/datasets/difficulty`: 제품 SemVer와 분리된 난이도 데이터 작업 영역. 현재 공개·합성·경계 15,000개 candidate는 학습 승인 전 상태
