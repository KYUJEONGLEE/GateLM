...
- [`proposals/dashboard-live-snapshot-polling-contract.md`](proposals/dashboard-live-snapshot-polling-contract.md): Web Dashboard aggregate snapshot은 30초, Live Requests는 2초로 분리 갱신하는 BFF 계약 후보
