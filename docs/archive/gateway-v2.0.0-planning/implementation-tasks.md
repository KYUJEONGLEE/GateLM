...
| Contracts | `specs/gateway/v2.0.0/schemas/gateway-stage-outcomes.schema.json`, `specs/gateway/v2.0.0/fixtures/gateway-stage-outcomes.fixture.json` only if contract-approved drift is needed |
...
| Docs/schema | `specs/gateway/v2.0.0/schemas/provider-catalog.schema.json`, `specs/gateway/v2.0.0/fixtures/provider-catalog.fixture.json` |
...
| Docs/schema | `specs/gateway/v2.0.0/schemas/runtime-snapshot.schema.json`, `specs/gateway/v2.0.0/fixtures/runtime-snapshot.fixture.json` |
...
| Docs/schema | `specs/gateway/v2.0.0/schemas/safety-domain-outcome.schema.json`, `specs/gateway/v2.0.0/fixtures/safety-domain-outcome.fixture.json` |
...
| Docs/schema | `specs/gateway/v2.0.0/schemas/request-detail.schema.json`, `specs/gateway/v2.0.0/schemas/dashboard-overview.schema.json`, fixtures with same basenames |
