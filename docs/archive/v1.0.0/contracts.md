...
RemoteSafetyEngine shadow/evaluation semantics, ctx/input fields, FastAPI endpoint shape, and sanitized error handling are defined in `docs/archive/v1.0.0/remote-safety-engine-contract.md`.
...
- Credential Lifecycle v1 source of truth is this section plus `docs/archive/v1.0.0/fixtures/credential-lifecycle.fixture.json` and `docs/archive/v1.0.0/schemas/credential-lifecycle.schema.json`.
...
The canonical JSON Schema for the terminal GatewayContext snapshot and its fixture wrapper is `docs/archive/v1.0.0/schemas/gateway-context.schema.json`. The canonical fixture example is `docs/archive/v1.0.0/fixtures/gateway-context.fixture.json`.
...
- detailed shadow/evaluation and FastAPI endpoint contract lives in `docs/archive/v1.0.0/remote-safety-engine-contract.md`.
...
Canonical v1 contract artifacts live under `docs/archive/v1.0.0`:

| Directory | Purpose |
|---|---|
| `docs/archive/v1.0.0/fixtures/` | Concrete examples used by demo, smoke, UI, and aggregation checks |
| `docs/archive/v1.0.0/schemas/` | JSON Schema files that define fixture or payload shape |
| `docs/archive/v1.0.0/checks/` | Optional checklists or smoke notes when they are added |
