...
| k6 release evidence | Ready as release evidence | `docs/archive/v1.0.0/checks/k6-baseline-report.md` |
| Safety rule quality | Ready as demo-baseline evidence | `docs/archive/v1.0.0/checks/rule-quality-report.md` |
| Demo scenario | Defined | `docs/archive/v1.0.0/demo-scenario.md` |
| RemoteSafetyEngine contract | Defined as optional | `docs/archive/v1.0.0/remote-safety-engine-contract.md` |
