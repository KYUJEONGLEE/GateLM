...
이 문서는 `docs/v2.0.0/contracts.md`의 Gateway hot path, RuntimeSnapshot, Provider, Request Log, Metrics, DB, API, Security-sensitive field 계약을 변경하지 않는다.

충돌이 있으면 `docs/v2.0.0/contracts.md`를 우선한다.
