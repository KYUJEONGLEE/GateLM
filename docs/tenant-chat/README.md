...
2. `docs/tenant-chat/schemas/*.schema.json`
3. `docs/tenant-chat/fixtures/*.fixture.json`
4. `docs/tenant-chat/implementation-plan.md`
5. `docs/tenant-chat/handoffs/*.md`
6. 기존 경로 호환성 확인이 필요할 때만 `docs/v2.0.0/**`, `docs/v2.1.0/**`
