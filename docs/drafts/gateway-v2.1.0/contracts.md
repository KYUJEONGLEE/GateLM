...
If this document conflicts with `specs/gateway/v2.0.0/contracts.md` on request handling, runtime policy, provider execution, logging, metrics, dashboard read models, or forbidden data, `specs/gateway/v2.0.0/contracts.md` wins.
...
1. `specs/gateway/v2.0.0/contracts.md` for Gateway/API/DB/Event/Metrics/Security-sensitive behavior
2. `docs/drafts/gateway-v2.1.0/contracts.md` for self-host packaging and installability
3. `docs/drafts/gateway-v2.1.0/implementation-plan.md`
4. `docs/drafts/gateway-v2.1.0/implementation-tasks.md`
5. `docs/drafts/gateway-v2.1.0/acceptance-test-matrix.md`
