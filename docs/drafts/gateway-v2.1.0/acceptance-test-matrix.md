...
`specs/gateway/v2.0.0/contracts.md` remains the official source for Gateway behavior, RuntimeSnapshot, Provider, Observability, API, DB, Event, Metrics, and Security-sensitive fields. This matrix does not create new product API, DB, Event, or Metrics contracts.
