...
`specs/gateway/v2.0.0/contracts.md` remains the source of truth for Gateway behavior, RuntimeSnapshot, Provider, Observability, API, DB, Event, Metrics, and Security-sensitive fields. These images only package the existing services for self-host delivery.
