...
This file stays intentionally short. Concrete file work is in `docs/drafts/gateway-v2.1.0/implementation-tasks.md`.

## 2. Source Of Truth

Read `docs/README.md` first when starting work.

For Gateway behavior, RuntimeSnapshot, Provider Adapter, Observability, API, DB, Event, Metrics, and Security-sensitive fields, `specs/gateway/v2.0.0/contracts.md` remains the source of truth.

For v2.1.0 self-host packaging and installability, use:

1. `specs/gateway/v2.0.0/contracts.md`
2. `docs/drafts/gateway-v2.1.0/contracts.md`
