...
This document is the coding task plan for `docs/drafts/gateway-v2.1.0/implementation-plan.md`.

`specs/gateway/v2.0.0/contracts.md` remains the source of truth for Gateway behavior, RuntimeSnapshot, Provider, Observability, API, DB, Event, Metrics, and Security-sensitive fields. v2.1.0 tasks must not redefine those contracts.
...
| Area | Paths |
|---|---|
| docs | `docs/drafts/gateway-v2.1.0/contracts.md`, `docs/drafts/gateway-v2.1.0/implementation-plan.md`, `docs/drafts/gateway-v2.1.0/implementation-tasks.md`, `docs/drafts/gateway-v2.1.0/acceptance-test-matrix.md` |
