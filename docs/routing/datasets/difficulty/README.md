...
다음 작업은 독립 LLM 재판정과 사람 adjudication이며, 병행해서 직접 사람 작성 Prompt 1,526개와 승인된 실제 사용자 Prompt를 확보해야 한다. 공개 7,000개는 규칙 기반 후보 라벨이므로 provenance·source·task slice별 평가와 adjudication 전에는 학습에 사용할 수 없다.
