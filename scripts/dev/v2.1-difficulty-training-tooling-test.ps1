...
try {
    ...
    & go test ./apps/gateway-core/internal/domain/routing ./apps/gateway-core/internal/tools/difficultymodel ./apps/gateway-core/cmd/difficulty-training-vector-export ./apps/gateway-core/cmd/difficulty-model-codegen
