...
Write-Host ""
Write-Host "GateLM v1 Metrics Handoff Smoke"
Write-Host "================================"
Write-Host "Runs the Gateway metrics handoff smoke test and prints request/metrics evidence."
Write-Host "Sensitive raw values are shown only as placeholders."
Write-Host ""
Write-Host "[Command]"
Write-Host "go test ./internal/http/handlers -run TestChatCompletionsMetricsHandoffSmoke -v"
...
try {
    go test ./internal/http/handlers -run TestChatCompletionsMetricsHandoffSmoke -v
