...
const policyText: Record<Locale, RuntimePolicyEditorText> = {
  en: {
    ...
    maxBucketTokens: "Maximum requests accepted at once",
    mode: "Mode",
    model: "Model",
    models: "Models",
    ...
    rateLimitEnabledTitle: "Use request limit",
    rateLimitInfo:
      "Limits requests per Application using the maximum and per-second request values.",
    rateLimitTab: "Rate Limit",
    redactAction: "Redact",
    refillRate: "Requests refilled per second",
    requestsPerSecondUnit: "req / sec",
  ...
  ko: {
    ...
    maxBucketTokens: "한번에 받을 최대 요청 수",
    mode: "모드",
    model: "모델",
    models: "모델",
    ...
    history: "런타임 이력",
    rateLimit: "요청 제한",
    rateLimitEnabledTitle: "요청 제한 사용",
    rateLimitInfo:
      "Application별 최대 요청 수와 초당 요청 수를 설정합니다.",
    rateLimitTab: "요청 제한",
    redactAction: "마스킹",
    refillRate: "초당 충전 요청 수",
    requestsPerSecondUnit: "건 / 초",
    requestsUnit: "건",
    remove: "삭제",
    rollback: "되돌리기",
    routing: "라우팅",
