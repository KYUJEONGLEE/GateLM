...
func TestSemanticCacheConfigDefaults(t *testing.T) {
	...
	if strings.Join(cfg.DenyCategories, ",") != "code,translation,summarization,extraction_json,reasoning,sensitive,safety_sensitive,tool_call,unknown" {
...
func TestSemanticCacheConfigDefaultCategoriesUseRoutingContract(t *testing.T) {
	...
	if got := strings.Join(cfg.DenyCategories, ","); got != "code,translation,summarization,extraction_json,reasoning,sensitive,safety_sensitive,tool_call,unknown" {
