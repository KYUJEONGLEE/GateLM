...
const (
	...
	SemanticCacheReasonDisabled                 = "semantic_disabled"
	SemanticCacheReasonInvalidBoundary          = "invalid_boundary"
	SemanticCacheReasonInvalidVector            = "invalid_vector"
	SemanticCacheReasonNoBoundaryMatch          = "boundary_mismatch"
	SemanticCacheReasonThresholdMiss            = "similarity_below_threshold"
	SemanticCacheReasonStoreSkipped             = "store_skipped"
	SemanticCacheReasonStored                   = "stored"
	SemanticCacheReasonPayloadUnsafe            = "unsafe_secret"
	SemanticCacheReasonEmbeddingFailure         = "embedding_failure"
	SemanticCacheReasonModeOff                  = "semantic_disabled"
	...
	SemanticCacheReasonCategoryScopeDenied      = "category_scope_denied"
	SemanticCacheReasonCategoryDenied           = "category_denied"
	SemanticCacheReasonStreamBypass             = "stream_bypass"
	SemanticCacheReasonFallbackStoreBypass      = "fallback_store_bypass"
	SemanticCacheReasonProviderErrorStoreBypass = "provider_error_store_bypass"

	SemanticCacheReasonEmbeddingInputUnavailable = "semantic_input_unavailable"
	SemanticCacheReasonEmbeddingInputUnsafe      = "unsafe_secret"
