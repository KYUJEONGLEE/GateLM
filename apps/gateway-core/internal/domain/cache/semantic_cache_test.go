...
func TestSemanticInMemoryStoreMissByBoundary(t *testing.T) {
	...
	cases := map[string]func(*SemanticCacheBoundary){
		...
		"providerAttemptProviderId":  func(b *SemanticCacheBoundary) { b.ProviderID = "provider-other" },
		"providerAttemptModelId":     func(b *SemanticCacheBoundary) { b.ModelID = "model-other" },
