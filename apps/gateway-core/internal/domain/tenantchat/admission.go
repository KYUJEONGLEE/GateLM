...
var (
	...
	ErrRuntimeUnavailable                = errors.New("tenant chat runtime unavailable")
	ErrQuotaHardLimit                    = errors.New("tenant chat user quota hard limit")
	ErrEmployeeWeeklyTokenQuotaHardLimit = errors.New("tenant chat employee weekly token quota hard limit")
