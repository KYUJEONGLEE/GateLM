...
production_load_env() {
  ...
  export GATELM_PRODUCTION_DISTRIBUTED_PII_UPSTREAM_HOST="${GATELM_PRODUCTION_DISTRIBUTED_PII_UPSTREAM_HOST:-10.78.2.50}"
  export GATELM_PRODUCTION_DISTRIBUTED_GATEWAY_UPSTREAM_HOST="${GATELM_PRODUCTION_DISTRIBUTED_GATEWAY_UPSTREAM_HOST:-10.78.2.20}"
...
production_validate_env() {
  ...
  production_require_env \
    ...
    GATELM_PRODUCTION_DISTRIBUTED_GATEWAY_UPSTREAM_HOST \
    ...
    GATELM_PRODUCTION_DISTRIBUTED_PII_UPSTREAM_HOST \
  ...
  [[ "${GATELM_PRODUCTION_DISTRIBUTED_GATEWAY_PRIVATE_IP}" == "10.78.2.20" || \
     "${GATELM_PRODUCTION_DISTRIBUTED_GATEWAY_PRIVATE_IP}" == "10.78.2.21" ]] || \
    production_fail "Unexpected Gateway bind IP."
  [[ "${GATELM_PRODUCTION_DISTRIBUTED_GATEWAY_UPSTREAM_HOST}" == "10.78.2.20" || \
     "${GATELM_PRODUCTION_DISTRIBUTED_GATEWAY_UPSTREAM_HOST}" == "10.78.2.10" ]] || \
    production_fail "Unexpected Gateway upstream host."
  ...
  [[ "${GATELM_PRODUCTION_DISTRIBUTED_PII_UPSTREAM_HOST}" == "10.78.2.50" || \
     "${GATELM_PRODUCTION_DISTRIBUTED_PII_UPSTREAM_HOST}" == "10.78.2.11" ]] || \
    production_fail "Unexpected PII upstream host."
  [[ "${GATELM_PRODUCTION_DISTRIBUTED_PII_PRIVATE_IP}" == "10.78.2.50" || \
     "${GATELM_PRODUCTION_DISTRIBUTED_PII_PRIVATE_IP}" == "10.78.2.51" ]] || \
    production_fail "Unexpected PII bind IP."
