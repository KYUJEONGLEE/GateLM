...
grep -Fq 'production_assert_tcp "PII v3.14 Service" "${GATELM_PRODUCTION_DISTRIBUTED_PII_UPSTREAM_HOST}" 8001' "${PREFLIGHT_PATH}"
grep -Fq 'production_assert_http_ready "PII v3.14 Service" "http://${GATELM_PRODUCTION_DISTRIBUTED_PII_UPSTREAM_HOST}:8001/readyz"' "${PREFLIGHT_PATH}"
