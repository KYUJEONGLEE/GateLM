...
grep -Fq 'GATEWAY_PII_SHADOW_ENABLED: ${GATEWAY_PII_SHADOW_ENABLED:-false}' "${COMPOSE_PATH}"
grep -Fq 'GATEWAY_PII_SHADOW_ALLOWED_TENANT_IDS: ${GATEWAY_PII_SHADOW_ALLOWED_TENANT_IDS:-}' "${COMPOSE_PATH}"
grep -Fq 'GATEWAY_PII_SHADOW_SAMPLE_BASIS_POINTS: ${GATEWAY_PII_SHADOW_SAMPLE_BASIS_POINTS:-500}' "${COMPOSE_PATH}"
...
grep -Fq 'GATEWAY_PII_SHADOW_ENABLED=false' "${ENV_PATH}"
grep -Fq 'GATEWAY_PII_SHADOW_ALLOWED_TENANT_IDS=' "${ENV_PATH}"
grep -Fq 'GATEWAY_PII_SHADOW_SAMPLE_BASIS_POINTS=500' "${ENV_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_ENABLED=false' "${ENV_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_CANDIDATE_MODEL_ID=/models/gatelm--koelectra-small-v3-pii-ner-quantized' "${ENV_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_CANDIDATE_VERSION=v0.1.1' "${ENV_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_MAX_ITEMS=5000' "${ENV_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_MAX_BYTES=10485760' "${ENV_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_TTL_SECONDS=43200' "${ENV_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_TIMEZONE=Asia/Seoul' "${ENV_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_WINDOW_START_HOUR=2' "${ENV_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_WINDOW_END_HOUR=5' "${ENV_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_POLL_INTERVAL_MS=250' "${ENV_PATH}"
...
grep -Fq 'AI_SERVICE_PII_SHADOW_ENABLED: ${AI_SERVICE_PII_SHADOW_ENABLED:-false}' "${PII_COMPOSE_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_CANDIDATE_MODEL_ID: ${AI_SERVICE_PII_SHADOW_CANDIDATE_MODEL_ID:-/models/gatelm--koelectra-small-v3-pii-ner-quantized}' "${PII_COMPOSE_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_CANDIDATE_VERSION: ${AI_SERVICE_PII_SHADOW_CANDIDATE_VERSION:-v0.1.1}' "${PII_COMPOSE_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_MAX_ITEMS: ${AI_SERVICE_PII_SHADOW_MAX_ITEMS:-5000}' "${PII_COMPOSE_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_MAX_BYTES: ${AI_SERVICE_PII_SHADOW_MAX_BYTES:-10485760}' "${PII_COMPOSE_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_TTL_SECONDS: ${AI_SERVICE_PII_SHADOW_TTL_SECONDS:-43200}' "${PII_COMPOSE_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_TIMEZONE: ${AI_SERVICE_PII_SHADOW_TIMEZONE:-Asia/Seoul}' "${PII_COMPOSE_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_WINDOW_START_HOUR: ${AI_SERVICE_PII_SHADOW_WINDOW_START_HOUR:-2}' "${PII_COMPOSE_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_WINDOW_END_HOUR: ${AI_SERVICE_PII_SHADOW_WINDOW_END_HOUR:-5}' "${PII_COMPOSE_PATH}"
grep -Fq 'AI_SERVICE_PII_SHADOW_POLL_INTERVAL_MS: ${AI_SERVICE_PII_SHADOW_POLL_INTERVAL_MS:-250}' "${PII_COMPOSE_PATH}"
